...
var templete ={
  ...
  seatList:function(flight_name, seat_id_list, user_mail_cookie){
    console.log(user_mail_cookie);
    ...
    <form action="/userRequest?id=${flight_name}" method='post' name='form1' >
      <table class="table1">
        <tr>
          <td>
          ...
          <td>
            <input type="text" name="email" id="email" value=${user_mail_cookie} readonly>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <button type="submit" id="cotect_btn">확인</button>
          </td>
        </tr>
